...
public class TaskListImpl implements TaskList {
    ...
    public Task createTask(CalendarDate startDate, CalendarDate endDate, String text, int priority, long effort, String description, String parentTaskId, String ttype) {
        ...
        el.addAttribute(new Attribute("task type", String.valueOf(ttype)));
